  ...
  return (
    <div className={styles.page}>
      <div className={styles.leftColumn} ref={leftColumnRef}>
        <Panel title={t('docx.title')} description={t('docx.description')}>
          <div className={styles.controls}>
            ...
            <Dropzone
              ...
              description={
                originalFile ? t('docx.dropzone.changeFile') : t('docx.dropzone.dropOrClick')
              }
              fileIcon={<FileText />}
              disabled={isGenerating}
            />
        ...
        >
          <div className={styles.settingsGrid}>
            ...
            <div className={styles.bottomFields}>
              ...
              <Field label={t('docx.actions.print')} htmlFor="docx-print">
                <Button
                  id="docx-print"
                  variant="secondary"
                  onClick={handlePrint}
